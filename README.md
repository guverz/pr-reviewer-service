...
В текущей версии не реализована аутентификация через AdminToken/UserToken, указанные в OpenAPI спецификации. Это можно добавить через middleware для проверки токенов в заголовках запросов.
